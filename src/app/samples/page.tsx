...
const BENEFITS = [
  {
    ...
    desc: "Learn the perfect format and structure for your assignments.",
    icon: Target,
  },
  {
    title: "Learn Referencing",
    desc: "See how proper referencing is done in academic writing.",
    icon: BookOpen,
  },
  {
    title: "Improve Writing Style",
    desc: "Enhance your writing style and academic expression.",
    icon: Pencil,
  },
  {
    title: "Save Research Time",
    desc: "Get a clear idea and save hours of research and effort.",
    icon: Timer,
  },
  {
    title: "Better Understanding",
    desc: "Improve your subject knowledge with real examples.",
    icon: GraduationCap,
  },
  {
    title: "100% Free Access",
    desc: "All samples are completely free to download and access.",
    icon: Download,
  },
];
  ...
  return (
    <main className="w-full font-sans text-gray-800 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-sm text-gray-500 text-left">
        ...
        <span className="text-gray-900 font-medium">Samples</span>
      </div>
      ...
      <section className="relative overflow-hidden max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4 lg:pb-6 pt-2 flex flex-col lg:flex-row items-center justify-between text-left">
        ...
        <div className="lg:w-1/2 relative z-20">
          ...
          <p className="text-gray-600 text-lg mb-8 max-w-lg">
            Access high-quality assignment examples written by academic experts.
            Explore 10,000+ samples across 150+ subjects to understand
          ...
          <div className="flex flex-col sm:flex-row gap-4 lg:hidden">
            <a
              href="#browse-samples"
              className="bg-purple-700 text-white text-center px-6 py-3 rounded-lg font-bold hover:bg-purple-800 transition flex-1"
            >
              Browse Samples &rarr;
            </a>
            <a
              href="#"
              className="bg-white text-purple-700 border-2 border-purple-200 text-center px-6 py-3 rounded-lg font-bold hover:bg-purple-50 transition flex-1"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 text-center">
        ...
        <p className="text-gray-500 mb-8">
          Explore samples from our most popular subjects
        </p>
      ...
      <section
        id="browse-samples"
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16 bg-[#fafaff] rounded-3xl"
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500">
            Find free assignment samples by subject area
          </p>
        </div>
        ...
        <div className="text-center mt-10">
          <Link
            href="#browse-samples"
            className="btn-shutter-blue-close inline-flex items-center font-bold py-2.5 px-6 rounded-lg"
          >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16 text-center">
        ...
        <p className="text-gray-500 mb-12">
          Our samples help you learn, understand and achieve better results
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 lg:gap-8">
          {BENEFITS.map((item, idx) => (
            ...
            >
              ...
              <h4 className="font-bold text-gray-900 mb-2 text-sm lg:text-base group-hover:text-purple-800">
                {item.title}
              </h4>
              <p className="text-xs text-gray-500 leading-relaxed px-2 group-hover:text-gray-700">
                {item.desc}
              </p>
            </div>
          ))}
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-12 items-start text-left">
          <div className="lg:w-1/3">
            ...
            <a
              href="/contact"
              className="btn-shutter-blue-close inline-flex items-center justify-center font-bold px-6 py-3 rounded-lg"
            >
              Contact Us &rarr;
            </a>
          </div>
