                  ...
                  {[
                    {
                      ...
                      url: "https://www.facebook.com/profile.php?id=61564613120071",
                    },

                    {
                      ...
                      url: "https://www.instagram.com/assignmentinneedofficial/?hl=en",
                    },
                    {
                      name: "YouTube",
                      ...
                      url: "https://www.youtube.com/@Assignmentinneed-uk",
                    },
                    {
                      name: "Pinterest",
                      bg: "bg-[#BD081C] text-white",
                      icon: (
                        <svg
                          viewBox="0 0 24 24"
                      ...
                      url: "https://in.pinterest.com/assignmentinneeduk/",
                    },
                  ].map((s) => (
                    <a
                      key={s.name}
