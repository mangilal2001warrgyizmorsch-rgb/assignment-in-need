      ...
      <div className="max-w-[1200px] w-full">
        ...
        >
          <h2 className="text-2xl md:text-[1.8rem] font-extrabold text-[#1e1b4b] m-0 mb-2">
            Assignment Help UK You Can Actually Trust
          </h2>
        ...
        >
          <div className="h-[300px] overflow-y-auto scroll-smooth [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden text-gray-700 space-y-6 text-[0.98rem] leading-relaxed">
            
            <p>
              Struggling with a deadline, a confusing brief, or a subject you just can't get your head around? 
              <strong> AssignmentInNeed (AIN)</strong> offers assignment help UK students rely on when things get tight. 
              Whether you need an assignment helper for a single tricky chapter or full help with assignments online from start to finish, 
              our UK-based writers work directly with your module requirements—no generic templates, no copy-paste answers.
            </p>

            <p>
              We built AIN around one idea: help with assignments should mean real subject knowledge, real referencing accuracy, 
              and real deadlines met—not a rushed, AI-generated draft with your name on it.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-2.5">
              <li>
                <strong>Subject-matched writers:</strong> Every assignment helper on our team is matched to your course level and subject—not a generalist writing outside their field.
              </li>
              <li>
                <strong>100% human-written work:</strong> No AI-generated content. Every piece is checked against AI-detection tools before it reaches you, so what you submit reads like your own understanding, properly written.
              </li>
              <li>
                <strong>Referencing done right:</strong> Harvard, APA, OSCOLA, MLA, whatever your university demands, formatted correctly, not guessed at.
              </li>
              <li>
                <strong>UK academic standards:</strong> We write to UK marking criteria, not a generic international template repackaged for the UK market.
              </li>
              <li>
                <strong>On-time, every time:</strong> Deadlines are non-negotiable in academic work. We treat them the same way.
              </li>
              <li>
                <strong>Direct communication:</strong> You can talk to your assigned writer throughout the process—not a support ticket that goes nowhere.
              </li>
            </ul>
            ...
            <ol className="list-decimal pl-5 space-y-2.5">
              <li>
                <strong>Tell us what you need:</strong> Share your brief, word count, and deadline.
              </li>
              <li>
                <strong>We match you with a writer:</strong> Based on subject, level, and referencing style.
              </li>
              <li>
                <strong>You review and request changes:</strong> Nothing goes final until you're satisfied.
              </li>
              <li>
                <strong>You submit with confidence:</strong> Properly referenced, plagiarism-checked, and human-written.
              </li>
            </ol>
            ...
            <p>
              We're not going to pretend this is a grey area. Assignment help exists to support your understanding—model answers, structural guidance, and properly researched drafts you can learn from and build on. What you submit and how you use what we provide is your responsibility under your university's academic integrity policy. We'd rather say that plainly than dodge it in a footnote.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-2.5">
              <li>
                Writers trained on UK grading rubrics, not adapted from a different education system
              </li>
              <li>
                Referencing formatted exactly to your university's required style
              </li>
              <li>
                Deadlines treated as fixed, not flexible
              </li>
              <li>
                A process where you can ask questions and request changes before you submit anything
              </li>
            </ul>
            <p>
