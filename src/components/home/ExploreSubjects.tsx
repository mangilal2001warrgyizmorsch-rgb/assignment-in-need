...
export default function ExploreSubjects() {
  ...
  const fallbackSubjects = [
    { name: "Business", slug: "business", count: "12,500+", bg: "bg-[#f3e8ff]", text: "text-[#7e22ce]", icon: "grid" },
    { name: "Law", slug: "law", count: "8,600+", bg: "bg-[#ffedd5]", text: "text-[#ea580c]", icon: "scale" },
    { name: "Nursing", slug: "nursing", count: "9,800+", bg: "bg-[#dcfce7]", text: "text-[#16a34a]", icon: "heart" },
    { name: "Psychology", slug: "psychology", count: "7,200+", bg: "bg-[#fee2e2]", text: "text-[#dc2626]", icon: "info" },
    { name: "Accounting", slug: "accounting", count: "11,200+", bg: "bg-[#e0f2fe]", text: "text-[#0284c7]", icon: "dollar" },
    { name: "Economics", slug: "economics", count: "5,200+", bg: "bg-[#f0fdf4]", text: "text-[#15803d]", icon: "chart" },
    { name: "Chemistry", slug: "chemistry", count: "4,200+", bg: "bg-[#f3e8ff]", text: "text-[#7e22ce]", icon: "triangle" },
    { name: "Sociology", slug: "sociology", count: "3,200+", bg: "bg-[#ffedd5]", text: "text-[#ea580c]", icon: "users" },
    { name: "Management", slug: "management", count: "9,200+", bg: "bg-[#dcfce7]", text: "text-[#16a34a]", icon: "clock" },
    { name: "Marketing", slug: "marketing", count: "5,500+", bg: "bg-[#fee2e2]", text: "text-[#dc2626]", icon: "twitter" }
  ];
